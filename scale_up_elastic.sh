...
docker-machine ssh manager "docker node update --label-add region=elasticsearch worker$1"
docker-machine ssh manager "docker service scale elastic_elasticsearch=$2 --detach"
